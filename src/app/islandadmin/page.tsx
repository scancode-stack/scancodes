...
//     try {
//       const res = await fetch(
//         `${process.env.NEXT_PUBLIC_BANK_API_URL}/food/all-food?page=${page}&limit=${limit}`,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//     try {
//       const res = await fetch(
//         `${process.env.NEXT_PUBLIC_BANK_API_URL}/food/delete-food`,
//         {
//           method: 'DELETE',
//           headers: {
//             'Content-Type': 'application/json',
...
//     const url = isEdit
//       ? `${process.env.NEXT_PUBLIC_BANK_API_URL}/food/edit-food/${form.id}`
//       : `${process.env.NEXT_PUBLIC_BANK_API_URL}/food/create-food`;
...
//     try {
//       const res = await fetch(
//         `${process.env.NEXT_PUBLIC_BANK_API_URL}/food/edit-food/${vatFoodId}`,
//         {
//           method: 'PUT',
//           headers: {
//             'Content-Type': 'application/json',
...
export default function DashboardPage() {
  ...
  const getToken = () => {
    if (typeof window === 'undefined') return null;
    return localStorage.getItem('island_token'); // ✅ FIX
  };
